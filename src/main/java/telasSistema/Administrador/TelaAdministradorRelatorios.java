...
public class TelaAdministradorRelatorios extends JFrame {
	 ...
	 * Create the panel.
	 */
	public TelaAdministradorRelatorios() {
		...
		JButton btnNewButton = new JButton("Gerar relatório de consultas por período");
		btnNewButton.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		btnNewButton.setBounds(28, 136, 332, 49);
		panel.add(btnNewButton);
		
		JButton btnAtivarDestivar = new JButton("Gerar relatorio por médico");
		btnAtivarDestivar.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		btnAtivarDestivar.setBounds(28, 232, 332, 48);
		panel.add(btnAtivarDestivar);
		
		JButton btnDefinirPermissesDe = new JButton("Visualizar histórico de agendamentos");
		btnDefinirPermissesDe.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		btnDefinirPermissesDe.setBounds(370, 232, 332, 49);
		...
		JButton btnGerarRelatorioDe = new JButton("Gerar relatorio de agendamentos");
		btnGerarRelatorioDe.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		btnGerarRelatorioDe.setBounds(370, 136, 332, 48);
		panel.add(btnGerarRelatorioDe);
