...
public class TelaAdministradorEditarPaciente extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaAdministradorEditarPaciente frame = new TelaAdministradorEditarPaciente();
	...
	public TelaAdministradorEditarPaciente() {
            ...
            protected void done() {
                ...
                try {
                    ...
                    if (endereco == null || endereco.temErro()) {
                        JOptionPane.showMessageDialog(TelaAdministradorEditarPaciente.this, 
